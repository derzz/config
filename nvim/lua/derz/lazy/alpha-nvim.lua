  ...
  config = function()
    ...
    local function split(source, sep)
      ...
      while true do
        ...
        local candidat = source:sub(1, a - 1) if candidat ~= "" then
          result[i] = candidat
        end
        i = i + 1
    ...
    -- Dashboard header/footer/buttons
    dashboard.section.header.val =
      vim.fn.readfile(vim.fs.normalize("~/.config/nvim/lua/derz/files/dashboard.txt"))
